...
### Analyze Decadal and Centural Temperatures
...
```
* From the boxplot, Americas region has the highest interquartile range. This makes its the region with the most changed temperature level.
...
### Do Temperatures Vary by Region?
...
### Linear Regression for Africa Region
...
### Linear Regression for Americas Region
...
### Linear Regression for Asia Region
...
### Linear Regression for Europe Region
...
### Linear Regression for Oceania Region
