...
The second dataset is sourced from the World Bank and contains data points by country from 1990 to 2013. This dataset consists of 6,336 observations for each of the following categories: CO2 emissions, renewable energy consumptions (%), population total, energy use, and forest area.  This dataset provides data on the potential predictor variables of surface temperature. 
...
### Results of Histogram and Q-Q Plot

#### Histogram
The histogram of global average surface temperature from 1743 to 2013 yielded expected results, with a mean of 17.2 on an overall left skewed distribution. This histogram allowed further analysis since it confirmed that global temperatures fall into an average level of approximately 17 degrees C or 63 degress F. A value too high or too low would require reassessment of the dataset, since humans require livable temperatures.
