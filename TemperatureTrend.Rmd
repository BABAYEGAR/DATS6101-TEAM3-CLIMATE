...
Third Report on Impacts of Climate Change in Iceland. (n.d.). Retrieved May 05, 2021, 
from https://en.vedur.is/climatology/iceland/climate-report

World Bank. (1990–2013a). Access to electricity (% of population) [Dataset]. 
https://data.worldbank.org/indicator/EG.ELC.ACCS.ZS?view=chart

World Bank. (1990–2013b). Annual freshwater withdrawals, total (billion cubic meters) [Dataset]. https://data.worldbank.org/indicator/ER.H2O.FWTL.K3?view=chart
...
World Bank. (1990–2013c). Fossil fuel energy consumption (% of total) [Dataset].
...
World Bank. (1990–2013d). PM2.5 air pollution, population exposed to levels exceeding WHO guideline value (% of total) [Dataset]. https://data.worldbank.org/indicator/EN.ATM.PM25.MC.ZS?view=chart
...
World Bank. (1990–2013e). Urban population (% of total population) [Dataset]. 
